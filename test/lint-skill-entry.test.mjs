...
// install and load in Claude Code, but the pi coding agent rejects a longer description
// at startup. The check exists to bound always-on context, so what matters is that the
