...
// docs/skills.md) hard-rejects a skill whose `description` exceeds 1024 characters —
// "description exceeds 1024 characters" at startup — so 1024 is the ceiling every
// operator accepts. Raise it only with evidence that every operator accepts more.
